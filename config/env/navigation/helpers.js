...
hbs.registerHelper('sidenav', function(){
      ...
      if(children.length > 0)
      {
        ...
        if(liClass === 'account')
        {
          var element = '<li class="has-children account '+ notifyClass + ' ' + smOnlyIcon +'"><a href="#"><img src="http://lorempixel.com/100/100/people" id="menu-avatar" alt="avatar">'+ icon + title + count +'</a><ul>';
        }
        else
        { 
